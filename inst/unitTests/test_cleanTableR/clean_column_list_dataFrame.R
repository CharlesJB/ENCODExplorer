test_column_list_dataFrame <- function (){
  library(RUnit)
  #load(file = system.file("extdata/ABC_replicates.rda", package = "ENCODExplorer")) #loading ABC_graph_replicates
  ...
  obs <- clean_column("replicates",ABC_subset)
