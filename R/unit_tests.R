...
test_file = "ENCODE/ENCODEdb/R/tests/ENCFF001VCK.broadPeak.gz.ori"
md5sum_test_file = "b58b4847e8d71d95471c4c017b4a5dc7"
load(file = "ENCODE/ENCODEdb/R/tests/test_encode_ds.rda") # encode_ds
load(file = "ENCODE/ENCODEdb/R/tests/test_encode_exp.rda") # encode_exp
load(file = "ENCODE/ENCODEdb/R/tests/test_rest_query_file.rda") #query_file
load(file = "ENCODE/ENCODEdb/R/tests/test_rest_search_file.rda") #search_file
load(file = "ENCODE/ENCODEdb/R/tests/test_rest_search_experiment.rda") #search_experiment
load(file = "ENCODE/ENCODEdb/R/tests/test_rest_search_dataset.rda") #search_dataset
load(file = "ENCODE/ENCODEdb/R/tests/test_mouse_donor_df.rda") #mouse_donor_df
