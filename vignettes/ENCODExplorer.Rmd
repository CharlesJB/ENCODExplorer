...
### shinyEncode
This function run the shinyApp of ENCODExplorer that implement the queryEncode 
and the fuzzySearch function. The createDesign and downdloadEncode function can also be use on the search results.
