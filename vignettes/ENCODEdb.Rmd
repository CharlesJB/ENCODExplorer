...
|---------|------------|-------------|
|set_accession|*the experiment or dataset accession*|experiment / dataset|
|assay|*the assay type*|experiment|
|biosample|*the biosample name*|experiment|
|status|*the experiment or dataset status*|experiment / dataset|
...
|file_status|*the file status*|experiment / dataset|
...
both.
When using **set_accession**, you will get all the files directly link to this accession 
...
dataset and dataset_accession in experiment)
