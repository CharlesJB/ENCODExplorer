...
set of "consensus peaks".

The "consensus peaks" identified by ENCODExplorer are those that were called 
in a user-defined minimum proportion of all replicate samples within a given 
condition. By default, this proportion is set to 1, or all replicates. You can
change it by setting the consensus_threshold parameter.
...
# Obtain a summary of all peaks for NR3C1 ChIP-Seq assays in the A549
# cell line.
res = queryGeneExpression("neural tube")
